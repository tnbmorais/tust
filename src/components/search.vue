<template>
  <div>
    ...
    <div><img width="100%" src="https://www.cm-stirso.pt/thumbs/cmsantotirso/uploads/writer_file/image/2840/Mapa_das_Linhas_1_980_2500.png" alt=""></div>
...
<script>
import { getStops, getAvailableStops, getAvailableRoutes } from '../services/transport.service';
